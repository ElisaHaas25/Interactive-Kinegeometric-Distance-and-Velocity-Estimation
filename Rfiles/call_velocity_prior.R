...
eval.prior.healpix <- function(r,p) {
   ...
   #}
    ...
    load(url(paste0("https://www2.mpia-hd.mpg.de/homes/calj/gedr3_distances_velocities/velocity_prior_fits/models/",p,".Robj")), envir=tempEnv)
    ...
    return(velprior)
    #close(tempEnv)
    #close(url(paste0("https://www2.mpia-hd.mpg.de/homes/calj/gedr3_distances_velocities/velocity_prior_fits/models/",p,".Robj")))
    }
