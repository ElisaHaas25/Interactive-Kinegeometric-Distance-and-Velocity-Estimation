...
def print_summary_statistics(sampler,walker_init,rInit,rStep,Nburnin,rSamp_kinegeo,rSamp_geo, totVelsamp, totMeanVel, n,thinfac,probs): 
    ...
    print('')
    print('estimated distance [kpc] (quantile 0.5):',rest_kinegeo)
    print('lower distance limit [kpc] (quantile 0.159):', rlo_kinegeo)
    print('upper distance limit [kpc] (quantile 0.841):', rhi_kinegeo)
    print('')
    print('Geometric distance:')
    print('')
    print('estimated distance [kpc] (quantile 0.5):',rest_geo)
    print('lower distance limit [kpc] (quantile 0.159):', rlo_geo)
    print('upper distance limit [kpc] (quantile 0.841):', rhi_geo)
    print('')
